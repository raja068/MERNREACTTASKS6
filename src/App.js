...
import './App.css';
import abhiImage from "./Raja.jpg"; 
...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <div className="user">
          <img src={abhiImage} alt="Bandlamudi Raja" />
          <h3 className="name">Bandlamudi RAja</h3>
        </div>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="info">
            <h3> <span> Name : </span>Raja </h3>
            <h3> <span> Qualification : </span> B.Tech(pursuing) </h3>
            <h3> <span> Address</span> Kanchikacherla</h3>
            <h3> <span> Strengths : </span> Hardwork, Dedication, Smartwork </h3>
            <h3> <span> Hobbies: </span> Movies,Playing Games</h3>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> rajabandlamudi77@gmail.com</h3>
              <h3> <i className="fas fa-phone"></i> 9502680199  </h3>
